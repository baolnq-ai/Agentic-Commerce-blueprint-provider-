...
const notificationFooter = cva("nv-notification-footer");
const NotificationFooter = forwardRef(({ className, ...props }, ref) => {
  return /* @__PURE__ */ jsx(
    Primitive.div,
    {
      ...mergeProps(
        {
          ...
          ref,
          "data-testid": NotificationTestIds.NotificationFooter
        },
        props
      )
    }
