...
export { clamp, convertValueToPercentage, formatStep, generateSteps, getAlignedStepPositionFromDimensions, getClosestStep, getElementDimensions, getExactThumbPosition, getStepPosition, getThumbInBoundsOffset, linearScale, observeElementSize };
